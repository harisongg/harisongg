...
require_once "queries/qupdate_mobil.php";
?>
    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <main>
            <div class="container mt-5">
                <h1 class="mb-4">Update Mobil</h1>
                <form method="post">
                    <div class="mb-3">
                        <label for="merk" class="form-label"><i class="bi bi-car-front"></i> Merk</label>
                        <input type="text" class="form-control" id="merk" name="merk" value="<?php echo $item['merk']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="model" class="form-label"><i class="bi bi-car-front-fill"></i> Model</label>
                        <input type="text" class="form-control" id="model" name="model" value="<?php echo $item['model']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="tahun" class="form-label"><i class="bi bi-calendar"></i> Tahun</label>
                        <input type="number" class="form-control" id="tahun" name="tahun" value="<?php echo $item['tahun']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label"><i class="bi bi-cash"></i> Harga (Rp)</label>
                        <input type="number" class="form-control" id="harga" name="harga" step="0.01" value="<?php echo $item['harga']; ?>" required>
                    </div>
